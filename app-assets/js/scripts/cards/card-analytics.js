...
$(window).on('load', function () {
  ...
  var $earningsStrokeColor4 = '#005EFF66';
  var $earningsStrokeColor5 = '#005EFF33';
  var $earningsStrokeColor6 = '#004ED499';
  ...
  var $goalOverviewChart2 = document.querySelector('#goal-overview-chart-2');
  var $goalOverviewChart3 = document.querySelector('#goal-overview-chart-3');
  ...
  var $earningsChart2 = document.querySelector('#earnings-donut-chart-2');
  ...
  goalChartOptions2 = {
    ...
    fill: {
      ...
      gradient: {
        ...
        type: 'horizontal',
        shadeIntensity: 0.5,
        gradientToColors: [window.colors.solid.info],
        inverseColors: true,
        opacityFrom: 1,
        opacityTo: 1,
        stops: [0, 100]
  ...
  goalChart2 = new ApexCharts($goalOverviewChart2, goalChartOptions2);
  goalChart2.render();



    // Goal Overview  Chart3
  // -----------------------------
  goalChartOptions3 = {
    chart: {
      height: 245,
  ...
  goalChart3 = new ApexCharts($goalOverviewChart3, goalChartOptions3);
  goalChart3.render();
  ...
  revenueChartOptions = {
    ...
    xaxis: {
      ...
      categories: ['05-01-2021', '10-01-2021', '15-01-2021', '20-01-2021', '30-01-2021'],
      axisBorder: {
        show: false
      },
      tickPlacement: 'on'
    ...
    series: [
      {
        name: 'This Month',
        data: [20000, 40000, 44800, 120500, 95500]
      },
      {
        name: 'Last Month',
        data: [40000, 100000, 26800, 100500, 85500]
      }
    ]
  };
  ...
  earningsChartOptions2 = {
    ...
    labels: ['Team A', 'Team B', 'Team C'],
    stroke: { width: 0 },
    colors: [$earningsStrokeColor4, $earningsStrokeColor5, $earningsStrokeColor6],
    grid: {
      padding: {
        right: -20,
        bottom: -8,
