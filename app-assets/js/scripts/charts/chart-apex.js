...
$(function () {
  ...
  if (typeof columnChartEl !== undefined && columnChartEl !== null) {
    var columnChart2 = new ApexCharts(columnChartEl, columnChartConfig);
    columnChart2.render();
  }
  ...
  // Column Chart3
  // --------------------------------------------------------------------
  var columnChartEl = document.querySelector('#column-chart3'),
    columnChartConfig = {
      chart: {
        height: 400,
        type: 'bar',
  ...
  if (typeof columnChartEl !== undefined && columnChartEl !== null) {
    var columnChart3 = new ApexCharts(columnChartEl, columnChartConfig);
    columnChart3.render();
  }
    ...
    // Column Chart4
  // --------------------------------------------------------------------
  var columnChartEl = document.querySelector('#column-chart4'),
    columnChartConfig = {
      chart: {
        height: 400,
        type: 'bar',
  ...
  if (typeof columnChartEl !== undefined && columnChartEl !== null) {
    var columnChart4 = new ApexCharts(columnChartEl, columnChartConfig);
    columnChart4.render();
  }
    ...
    // Column Chart5
  // --------------------------------------------------------------------
  var columnChartEl = document.querySelector('#column-chart5'),
    columnChartConfig = {
      chart: {
        height: 400,
        type: 'bar',
      ...
      series: [
        ...
        },
        {
          ...
          data: [66, 70, 25, 30, 30, 25, 25, 50, 48, 10]
        }
      ],
      xaxis: {
        categories: ['Jan', 'Feb', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November','December']
  ...
  // Line Chart2
  // --------------------------------------------------------------------
  var lineChartEl = document.querySelector('#line-chart2'),
    lineChartConfig = {
      chart: {
        height: 400,
        type: 'line',
  ...
  if (typeof lineChartEl !== undefined && lineChartEl !== null) {
    var lineChart2 = new ApexCharts(lineChartEl, lineChartConfig);
    lineChart2.render();
  }
  ...
  // Bar Chart2
  // --------------------------------------------------------------------
  var barChartEl = document.querySelector('#bar-chart2'),
    barChartConfig = {
      chart: {
        height: 400,
        type: 'bar',
      ...
      xaxis: {
        categories: ['Delivery', 'Engineering', 'FAT', 'Inspection', 'Material', 'Quality Documents', 'Rework']
      },
      yaxis: {
        opposite: isRtl
      }
  ...
  if (typeof barChartEl !== undefined && barChartEl !== null) {
    var barChart2 = new ApexCharts(barChartEl, barChartConfig);
    barChart2.render();
  }

  // Bar Chart3
  // --------------------------------------------------------------------
  var barChartEl = document.querySelector('#bar-chart3'),
    barChartConfig = {
      chart: {
        height: 400,
        type: 'bar',
      ...
      xaxis: {
        categories: ['LT1', 'Fatal Accident', 'Minor Injury', 'Tier 1 Safety', 'Illness (Non Covid-19)', 'Covid-19 Close Contact', 'Covid-19 Confirmed Contact']
      },
      yaxis: {
        opposite: isRtl
      }
  ...
  if (typeof barChartEl !== undefined && barChartEl !== null) {
    var barChart3 = new ApexCharts(barChartEl, barChartConfig);
    barChart3.render();
  }
  ...
  var donutChartEl = document.querySelector('#donut-chart'),
    donutChartConfig = {
      ...
      labels: ['Human Error', 'Lack of Proper Training', 'Unsafe Methods', 'Lack of Safery Devices'],
      series: [85, 16, 50, 50],
      colors: [
