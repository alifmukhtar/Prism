...
$(function () {
  ...
  if ($('#custom-icons').length) {
    var customIcons = L.map('custom-icons').setView([2.9013868349354777, 101.65206845042127], 13);
    ...
    L.marker([2.9013868349354777, 101.65206845042127], {
      icon: redLeaf
    }).addTo(customIcons);
    L.marker([2.9092505807253466, 101.65492649338344], {
      icon: greenLeaf
    }).addTo(customIcons);
    L.marker([2.9179436049276504, 101.68393615866373], {
      icon: orangeLeaf
    }).addTo(customIcons);
    L.tileLayer('https://{s}.tile.osm.org/{z}/{x}/{y}.png', {
      attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
